...
const startServer = async () => {
  try {
    console.log('🚀 Starting ZK-PRET Async Web Application...');
    console.log(`📡 Environment: ${process.env.NODE_ENV || 'development'}`);
    console.log(`🔧 Server Type: ASYNC HTTP`);
    console.log(`🎯 Operation Mode: ${process.env.OPERATION_MODE || 'HTTP'}`);
    ...
    server.listen(ZK_PRET_WEB_APP_PORT, ZK_PRET_WEB_APP_HOST, () => {
      console.log('🎉 ZK-PRET Async Web App is ready!');
